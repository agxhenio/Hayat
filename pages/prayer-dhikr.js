...
export function mount(page, context, appContext) {
  ...
  function quranSuccess(container, item, verses) {
    ...
    groups.forEach(function (group) {
      var surah = document.createElement('section'); surah.className = 'post-dhikr-quran__surah';
      var heading = document.createElement('h3'); heading.className = 'post-dhikr-quran__surah-title'; heading.textContent = 'Sureja ' + group.surah;
      var arabicGroup = document.createElement('div'); arabicGroup.className = 'post-dhikr-quran__group'; var arabicHeading = document.createElement('p'); arabicHeading.className = 'post-dhikr-quran__group-title'; arabicHeading.textContent = 'Arabisht'; arabicGroup.appendChild(arabicHeading);
      group.verses.forEach(function (verse) { var arabic = document.createElement('p'); arabic.className = 'post-dhikr-quran__arabic text-quran'; arabic.lang = 'ar'; arabic.dir = 'rtl'; arabic.textContent = verse.arabicText; arabicGroup.appendChild(arabic); });
      var transliterationGroup = document.createElement('div'); transliterationGroup.className = 'post-dhikr-quran__group'; var transliterationHeading = document.createElement('p'); transliterationHeading.className = 'post-dhikr-quran__group-title'; transliterationHeading.textContent = 'Transliterim'; transliterationGroup.appendChild(transliterationHeading);
      group.verses.forEach(function (verse) { var transliteration = document.createElement('p'); transliteration.className = 'post-dhikr-quran__transliteration'; var entry = getQuranTransliterationSq(verse.verseKey); var value = entry && entry.transliterationSq; transliteration.textContent = value || 'Transliterimi nuk është i disponueshëm në këtë hyrje.'; if (!value) transliteration.classList.add('post-dhikr-quran__transliteration--missing'); transliterationGroup.appendChild(transliteration); });
      var translationGroup = document.createElement('div'); translationGroup.className = 'post-dhikr-quran__group'; var translationHeading = document.createElement('p'); translationHeading.className = 'post-dhikr-quran__group-title'; translationHeading.textContent = 'Përkthimi shqip'; translationGroup.appendChild(translationHeading);
      group.verses.forEach(function (verse) { var block = document.createElement('section'); block.className = 'post-dhikr-quran__verse'; var translation = document.createElement('p'); translation.className = 'post-dhikr-quran__translation'; var hardcodedTranslation = getQuranTranslationSq(verse.verseKey); translation.textContent = hardcodedTranslation || verse.translationSq; var reference = document.createElement('p'); reference.className = 'post-dhikr-quran__reference'; reference.textContent = verse.verseKey; block.append(translation, reference); if (!hardcodedTranslation && verse.footnotesSq) { var details = document.createElement('details'); details.className = 'post-dhikr-quran__footnotes'; var summary = document.createElement('summary'); summary.className = 'post-dhikr-quran__footnotes-summary'; summary.textContent = 'Shënime të përkthimit'; var footnotes = document.createElement('p'); footnotes.textContent = verse.footnotesSq; details.append(summary, footnotes); block.appendChild(details); } translationGroup.appendChild(block); });
